...
const translations = {
    uk: {
        ...
        hero: {
            ...
            subtitle2: "З листопада 2024 року лікар з правом автономної роботи в Португалії<br>(cédula profissional n° 79747) <img src=\"assets/images/pt-flag.svg\" alt=\"PT\" class=\"flag-icon-inline\" width=\"20\" height=\"14\" style=\"display: inline-block; vertical-align: middle; margin-left: 4px;\">",
            ...
            feature2: "Понад 14 років медичного стажу (практикую з 2011 року)",
            feature3: "Більше 6 років успішно проводжу онлайн-консультацій",
            feature4: "Глибокий досвід у протоколах лікування медикаментозної алергії",
            feature5: "Спікер на понад 50 медичних конференціях",
        ...
        about: {
            title: "Про мене",
            text2: "<h3>Як алерголог:</h3><ul><li>Проводжу діагностику та лікування пацієнтів з атопічним дерматитом, гострою та хронічною кропивянкою, бронхіальною астмою, алергічним ринітом і іншими алергопатологіями.</li><li>Призначаю АСІТ імунотерапію.</li><li>Консультую щодо протоколів градуйованого введення продуктів, оральної десенсибілізації.</li></ul><h3>Як педіатр:</h3><ul><li>Допомогаю ростити здорових дітей по всьому світу 🌍.</li><li>Контролюємо графіки вакцин.</li><li>Вводимо прикорм.</li><li>Не даємо зайвих ліків.</li></ul>",
            text2Tablet: "<div class=\"about-text\"><h3>Як алерголог:</h3><ul><li>Проводжу діагностику та лікування пацієнтів з атопічним дерматитом, гострою та хронічною кропивянкою, бронхіальною астмою, алергічним ринітом і іншими алергопатологіями.</li><li>Призначаю АСІТ імунотерапію.</li><li>Консультую щодо протоколів градуйованого введення продуктів, оральної десенсибілізації.</li></ul></div><div class=\"about-text\"><h3>Як педіатр:</h3><ul><li>Допомогаю ростити здорових дітей по всьому світу 🌍.</li><li>Контролюємо графіки вакцин.</li><li>Вводимо прикорм.</li><li>Не даємо зайвих ліків.</li></ul></div>",
            momNote: "Як мама 2-х дітей – не даю порад, які батьки не зможуть виконати ;)"
        },
        services: {
            title: "Мої послуги",
    ...
    en: {
        ...
        hero: {
            ...
            subtitle2: "Since November 2024, doctor with the right to autonomous practice in Portugal<br>(cédula profissional n° 79747) <img src=\"assets/images/pt-flag.svg\" alt=\"PT\" class=\"flag-icon-inline\" width=\"20\" height=\"14\" style=\"display: inline-block; vertical-align: middle; margin-left: 4px;\">",
            description: "Providing quality medical care with an individual approach to each patient. Book your consultation today.",
            cta: "Book an Appointment",
            learn: "Learn More",
            feature2: "Over 14 years of medical experience (practicing since 2011)",
            feature3: "More than 6 years successfully conducting online consultations",
            feature4: "Deep experience in drug allergy treatment protocols",
            feature5: "Speaker at over 50 medical conferences",
    ...
    pt: {
        ...
        hero: {
            ...
            subtitle2: "Desde novembro de 2024, médica com direito ao exercício autónomo em Portugal<br>(cédula profissional n° 79747) <img src=\"assets/images/pt-flag.svg\" alt=\"PT\" class=\"flag-icon-inline\" width=\"20\" height=\"14\" style=\"display: inline-block; vertical-align: middle; margin-left: 4px;\">",
            ...
            learn: "Saber Mais",
            feature2: "Mais de 14 anos de experiência médica (praticando desde 2011)",
            feature3: "Mais de 6 anos realizando consultas online com sucesso",
            feature4: "Experiência profunda em protocolos de tratamento de alergia medicamentosa",
            feature5: "Palestrante em mais de 50 conferências médicas",
        ...
        about: {
            title: "Sobre Mim",
            text2: "<h3>Como alergologista:</h3><ul><li>Realizo diagnóstico e tratamento de pacientes com dermatite atópica, urticária aguda e crónica, asma brônquica, rinite alérgica e outras alergopatologias.</li><li>Prescrevo imunoterapia ASIT.</li><li>Consulto sobre protocolos de introdução gradual de alimentos, dessensibilização oral.</li></ul><h3>Como pediatra:</h3><ul><li>Ajudo a criar crianças saudáveis em todo o mundo 🌍.</li><li>Controlamos os calendários de vacinação.</li><li>Introduzimos alimentos complementares.</li><li>Não prescrevemos medicamentos desnecessários.</li></ul>",
            text2Tablet: "<div class=\"about-text\"><h3>Como alergologista:</h3><ul><li>Realizo diagnóstico e tratamento de pacientes com dermatite atópica, urticária aguda e crónica, asma brônquica, rinite alérgica e outras alergopatologias.</li><li>Prescrevo imunoterapia ASIT.</li><li>Consulto sobre protocolos de introdução gradual de alimentos, dessensibilização oral.</li></ul></div><div class=\"about-text\"><h3>Como pediatra:</h3><ul><li>Ajudo a criar crianças saudáveis em todo o mundo 🌍.</li><li>Controlamos os calendários de vacinação.</li><li>Introduzimos alimentos complementares.</li><li>Não prescrevemos medicamentos desnecessários.</li></ul></div>",
            momNote: "Como mãe de 2 filhos – não dou conselhos que os pais não possam seguir ;)"
        },
        services: {
            title: "Meus Serviços",
